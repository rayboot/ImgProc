...
import com.rayboot.listeners.OnPhotoTagTapListener;
import com.rayboot.listeners.OnPhotoTagsChangedListener;
import com.rayboot.model.PhotoObj;
import com.rayboot.model.PhotoTag;
import com.rayboot.util.Flags;
import uk.co.senab.photoview.PhotoViewAttacher;

@SuppressLint("ViewConstructor") @SuppressWarnings("deprecation")
        ...
        PhotoViewAttacher.OnMatrixChangedListener
{
    ...
    private final PhotoObj mUpload;
            ...
            PhotoObj upload)
    {
        ...
        mPhotoTagInAnimation =
                AnimationUtils.loadAnimation(context, R.anim.tag_fade_in);
        mPhotoTagOutAnimation =
                AnimationUtils.loadAnimation(context, R.anim.tag_fade_out);

        LayoutInflater inflater = LayoutInflater.from(context);

        mButton = (CheckableImageView) inflater.inflate(
                R.layout.layout_check_button_lrg, this, false);
        mButton.setOnClickListener(this);
        addView(mButton);

        mFaceDetectIndicator =
                inflater.inflate(R.layout.layout_face_detect, this, false);
    ...
    public PhotoObj getPhotoSelection()
    {
        return mUpload;
    }
    ...
    {
        View tagLayout =
                mLayoutInflater.inflate(R.layout.layout_photo_tag, mTagLayout,
                        false);
    ...
    private void layoutTag(final View tagLayout, final RectF rect,
            final Rect parentRect, final boolean animate)
    {
        ...
        AbsoluteLayout.LayoutParams lp =
                (AbsoluteLayout.LayoutParams) tagLayout.getLayoutParams();
     ...
     */
    public void onFaceDetectionStarted(PhotoObj selection)
    {
    ...
    public void onFaceDetectionFinished(PhotoObj selection)
    {
        mFaceDetectIndicator.post(new Runnable()
        {
            public void run()
